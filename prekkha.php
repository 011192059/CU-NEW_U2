  ...
  <img src="images/Heading_Image_Text.png" width="600" height="120" alt="Clickable header image">
    ...
    <div class="menuBox">
      ...
      <a style="font-size: 2em; padding-right: 10px; padding-left: 10px; padding-bottom: 10px; color:black" href="home.php"><i class="fa fa-home"></i></a>
        ...
        <div class="column">
        <a href="images/প্রেক্ষা। প্রথম সংখ্যা.pdf" target="_taru"> <img src="images/prekkha1.jpg" alt="Example Image 1"></a> 
        </div>
         </div> 
              <a href="images/প্রেক্ষা। দ্বিতীয় সংখ্যা.pdf" target="_taru"> <img src="images/prekkha2.jpg" alt="Example Image 2"></a>
              <a href="images/প্রেক্ষা। তৃতীয় সংখ্যা। ডিসেম্বর-২০২০।.pdf" target="_taru"> <img src="images/prekkha3.jpg" alt="Example Image 3"></a>
              <a href="images/প্রেক্ষা। চতুর্থ সংখ্যা.pdf" target="_taru"> <img src="images/prekkha4.jpg" alt="Example Image 4"></a>
              <a href="images/প্রেক্ষা । পঞ্চম সংখ্যা.pdf" target="_taru"> <img src="images/prekkha5.jpg" alt="Example Image 5"></a>     
