  ...
  <img src="images/Heading_Image_Text.png" width="600" height="120" alt="Clickable header image">
    ...
    <div class="menuBox">
      ...
      <a style="font-size: 2em; padding-right: 10px; padding-left: 10px; padding-bottom: 10px; color:black" href="home.php"><i class="fa fa-home"></i></a>
        ...
        <div id="top-image">
           <p style="font-weight: bold; font-size:24px; color:rgb(212, 69, 17);"><u>১0ম আবৃত্তি উৎসব</u></p>
         </div>  
        ...
        <div class="column">
          <img src="images/101.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/102.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/103.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/104.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/105.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/106.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/107.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/108.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/109.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/110.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/111.jpg"alt="Slide1">
        </div>
