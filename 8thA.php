  ...
  <img src="images/Heading_Image_Text.png" width="600" height="120" alt="Clickable header image">
    ...
    <div class="menuBox">
      ...
      <a style="font-size: 2em; padding-right: 10px; padding-left: 10px; padding-bottom: 10px; color:black" href="home.php"><i class="fa fa-home"></i></a>
        ...
        <div id="top-image">
           <p style="font-weight: bold; font-size:24px; color:rgb(212, 69, 17);"><u>৮ম আবৃত্তি উৎসব</u></p>
        ...
        <div class="column">
          <img src="images/81.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/82.JPG"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/83.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/84.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/85.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/86.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/87.jpg"alt="Slide1">
        </div>
        <div class="column">
          <img src="images/88.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/89.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/810.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/811.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/812.jpg"alt="Slide1">
        </div>
