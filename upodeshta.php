  ...
  <img src="images/Heading_Image_Text.png" width="600" height="120" alt="Clickable header image">
    ...
    <div class="menuBox">
      ...
      <a style="font-size: 2em; padding-right: 10px; padding-left: 10px; padding-bottom: 10px; color:black" href="home.php"><i class="fa fa-home"></i></a>
        ...
        <h2>নূসরাত জাহান রিমি</h2>
        </div>
        </div>
        <div class="column">
        <div class="card">
          <img src="images/Rajib.jpeg"alt="Slide1">
        <h2>নাহিদ আশরাফ রাজিব</h2>
        </div>
        </div>
        <div class="column">
        <div class="card">
        ...
        <h2>ভাগ্যশ্বরী চাকমা</h2>
        </div>
        </div>
        <div class="column">
        <div class="card">
          <img src="images/Borhan .jpg"alt="Slide1">
        <h2>বোরহান উদ্দিন রব্বানী</h2>
        </div>
        </div>
        <div class="column">
        <div class="card">
