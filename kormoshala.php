  ...
  <img src="images/Heading_Image_Text.png" width="600" height="120" alt="Clickable header image">
    ...
    <div class="menuBox">
      ...
      <a style="font-size: 2em; padding-right: 10px; padding-left: 10px; padding-bottom: 10px; color:black" href="home.php"><i class="fa fa-home"></i></a>
        ...
        <div id="top-image">
           <p style="font-weight: bold; font-size:24px; color:rgb(37, 37, 102);"><u>কর্মশালা</u></p>
         </div>  
        ...
        <div class="column">
          <img src="images/k1.jpeg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/k2.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/k3.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/k4.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/k5.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/k6.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/k7.jpg"alt="Slide1">
        </div>

        <div class="column">
          <img src="images/k8.jpg"alt="Slide1">
        </div>
